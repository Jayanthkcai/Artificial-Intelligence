...
namespace IdentifySimilarFaces
{
    class Program
    {
        // URL path for the images.
        const string IMAGE_BASE_URL = "https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/";
        ...
        static void Main(string[] args)
        {
            ...
            IdentifyInPersonGroup(faceClient, IMAGE_BASE_URL, RecognitionModel.Recognition04).Wait();
        ...
        public static async Task IdentifyInPersonGroup(IFaceClient client, string url, string recognitionModel)
        {
            ...
            string sourceImageFileName = "../../../test-images/identification1.jpg";
